...
\Abstract{
  ...
  users fit established causal estimators while keeping the assumption checks
  and validation context needed for replication and peer review attached to the
  estimate. In the current
...
CausalLens occupies a narrow but practical niche: it is most useful where analysts value a
...
used generative-AI tools for limited editorial assistance and DOCX conversion
support under direct supervision; the author reviewed and takes responsibility
for all technical claims, code, citations, and final wording. The author thanks the open-source contributors to
