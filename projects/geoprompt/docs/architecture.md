...
- `frame.py` wraps point records with geometry-aware methods, CRS state, nearest and proximity join logic, assignment, catchment, and overlay summary workflows, predicate joins, service-area helpers, nearest-assignment workflows, and dissolve behavior.
